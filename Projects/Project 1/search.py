...
def depthFirstSearch(problem):
    ...
    visited = []
    path = []
    pathToCurrent = util.Stack()
    currState = fringe.pop()
    while (not problem.isGoalState(currState)):
        if currState not in visited:
            visited.append(currState)
            successors = problem.getSuccessors(currState)
            for successor, direction, price in successors:
...
def uniformCostSearch(problem):
    ...
    while not fringe.isEmpty():
        currState, path, currCost = fringe.pop()
        ...
        if currState not in visited:
            ...
            for successor, action, stepCost in problem.getSuccessors(currState):
                if successor not in visited:
                    ...
                    fringe.push((successor, newPath, newCost), heuristicCost)
